...
const setReview = (viewIndex) => {
  author.textContent = reviews[viewIndex].name;
  job.textContent = reviews[viewIndex].job;
  info.textContent = reviews[viewIndex].text;
  personImg.src = reviews[viewIndex].img;
}
